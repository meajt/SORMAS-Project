...
public class LocationEditForm extends AbstractEditForm<LocationDto> {
    ...
    private static final String HTML_LAYOUT =
            ...
            divs(
                    ...
                    fluidRowLocs(FACILITY_TYPE_GROUP_LOC, LocationDto.FACILITY_TYPE, LocationDto.OTHER_FACILITY_TYPE),
    ...
    protected void addFields() {
        ...
        otherFacilityType = addField(LocationDto.OTHER_FACILITY_TYPE, TextField.class);
        otherFacilityType.setVisible(false);
        ...
        facilityTypeGroup.addValueChangeListener(e -> {
            if (!skipFacilityTypeUpdate) {
                FieldHelper.removeItems(facility);
                setVisibilityToOtherFacility();
                if (facilityTypeGroup.getValue() != FacilityTypeGroup.OTHERS) {
    ...
    public void discard() throws SourceException {
        ...
        if (locationDto != null) {
            ...
            if (facilityType != null) {
                ...
                if (locationDto.getOtherFacilityType() != null && !locationDto.getOtherFacilityType().isBlank()) {
                    facilityTypeGroup.setValue(FacilityTypeGroup.OTHERS);
                } else {
    ...
    private void setVisibilityToOtherFacility() {
        if (facilityTypeGroup.isVisible()) {
            FacilityTypeGroup selectedFacilityGroup = (FacilityTypeGroup) facilityTypeGroup.getValue();
            if (selectedFacilityGroup == FacilityTypeGroup.OTHERS) {
                facilityType.setVisible(false);
                facility.setVisible(false);
                otherFacilityType.setVisible(true);
                facilityType.clear();
                facility.clear();
            } else {
