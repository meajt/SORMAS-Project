...
import static de.symeda.sormas.api.epidata.CaseDetectionMethod.*;
import static org.junit.jupiter.api.Assertions.*;

class CaseDetectionMethodTest {
    ...
    void getCaseDetectionMethodTest() {
        ...
        Assertions.assertTrue(result.containsAll(List.of(VOLUNTARY, HOSPITAL_VISIT_FOR_OTHER_PURPOSE)));

        result = getCaseDetectionMethod(CaseDetectionMethodGroup.ACTIVE_CASE_DETECTION, Disease.MALARIA);
