...
public class AggregateReportResource extends EntityDtoResource {
	...
	@POST
	@Path("/push")
	public Response postAggregateReports(@Valid List<AggregateReportDto> dtos) {
		return savePushedDtosNonAtomic(dtos, FacadeProvider.getAggregateReportFacade()::saveAggregateReport);
	}
